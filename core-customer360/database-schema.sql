...
VALUES
    ...
    (
        ...
        'GENERAL',
        'all',
        'User viewed a web page or app screen.',
        FALSE,
        NULL,
        10
    ),
    ...
    (
        ...
        'GENERAL',
        'all',
        'User viewed a content asset (article, video, listing).',
        FALSE,
        NULL,
        30
    ),
    (
        ...
        'GENERAL',
        'all',
        'User viewed a generic catalog item.',
        FALSE,
        NULL,
        40
    ),
    (
        ...
        'GENERAL',
        'all',
        'User authenticated into the app/site.',
        FALSE,
        NULL,
        50
    ),
    (
        ...
        'GENERAL',
        'all',
        'User downloaded a file/document.',
        FALSE,
        NULL,
        60
    ),
    (
        ...
        'GENERAL',
        'all',
        'User shared content to a social network.',
        FALSE,
        NULL,
        70
    ),
    (
        ...
        'GENERAL',
        'all',
        'User submitted a contact-us form.',
        FALSE,
        NULL,
        80
    ),
    (
        ...
        'GENERAL',
        'all',
        'An ad was rendered/served to the user.',
        FALSE,
        NULL,
        90
    ),
...
(
    ...
    'FEEDBACK',
    'all',
    'User submitted a product/service review.',
    FALSE,
    NULL,
    120
),
(
    ...
    'FEEDBACK',
    'all',
    'Negative feedback/sentiment recorded.',
    FALSE,
    NULL,
    130
),
(
    ...
    'FEEDBACK',
    'all',
    'Positive feedback/sentiment recorded.',
    FALSE,
    NULL,
    140
),
...
(
    ...
    'COMMERCE',
    'retail',
    'User started/completed checkout.',
    FALSE,
    'order_total',
    170
),
...
(
    ...
    'COMMERCE',
    'retail',
    'User subscribed to a recurring plan.',
    TRUE,
    'plan_value',
    210
),
...
(
    ...
    'FINANCE',
    'banking',
    'A loan application was approved.',
    TRUE,
    'loan_amount',
    240
),
...
(
    ...
    'FINANCE',
    'banking',
    'User opened a new bank account.',
    TRUE,
    NULL,
    260
),
(
    ...
    'FINANCE',
    'banking',
    'User transferred money between accounts.',
    FALSE,
    'transfer_amount',
    270
),
(
    ...
    'FINANCE',
    'banking',
    'User paid a bill via the banking app.',
    FALSE,
    'bill_amount',
    280
),
(
    ...
    'FINANCE',
    'banking',
    'User checked their credit score.',
    FALSE,
    NULL,
    290
),
(
    ...
    'FINANCE',
    'banking',
    'User completed KYC/eKYC verification.',
    FALSE,
    NULL,
    300
),
...
(
    ...
    'STOCK_TRADING',
    'banking',
    'User viewed a stock/security detail page.',
    FALSE,
    NULL,
    310
),
...
(
    ...
    'STOCK_TRADING',
    'banking',
    'User viewed their investment portfolio.',
    FALSE,
    NULL,
    340
),
...
(
    ...
    'TRAVEL',
    'travel',
    'User viewed a destination/listing page.',
    FALSE,
    NULL,
    370
),
(
    ...
    'TRAVEL',
    'travel',
    'User completed a travel booking.',
    TRUE,
    'booking_value',
    380
),
(
    ...
    'TRAVEL',
    'travel',
    'User checked in for a flight/hotel stay.',
    FALSE,
    NULL,
    390
),
(
    ...
    'TRAVEL',
    'travel',
    'User checked out of a flight/hotel stay.',
    FALSE,
    NULL,
    400
),
(
    ...
    'TRAVEL',
    'travel',
    'User cancelled a travel booking.',
    FALSE,
    'booking_value',
    410
),
(
    ...
    'TRAVEL',
    'travel',
    'User added a destination/trip to their wishlist.',
    FALSE,
    NULL,
    420
),
...
(
    ...
    'REAL_ESTATE',
    'real_estate',
    'User viewed a property listing.',
    FALSE,
    NULL,
    430
),
(
    ...
    'REAL_ESTATE',
    'real_estate',
    'User favorited a property listing.',
    FALSE,
    NULL,
    440
),
(
    ...
    'REAL_ESTATE',
    'real_estate',
    'User requested a property tour.',
    FALSE,
    NULL,
    450
),
...
(
    ...
    'REAL_ESTATE',
    'real_estate',
    'User contacted a real-estate agent.',
    FALSE,
    NULL,
    470
),
(
    ...
    'REAL_ESTATE',
    'real_estate',
    'User submitted a mortgage inquiry form.',
    FALSE,
    'loan_amount',
    480
),
(
    ...
    'REAL_ESTATE',
    'real_estate',
    'User received mortgage pre-approval.',
    FALSE,
    'loan_amount',
    490
),
(
    ...
    'REAL_ESTATE',
    'real_estate',
    'User submitted an offer on a property.',
    TRUE,
    'offer_amount',
    500
) ON CONFLICT (event_name) DO
UPDATE
SET
...
INSERT INTO
    customer360.cdp_profile_attributes (
...
VALUES
    ...
    (
        ...
        'master_profile_id',
        'Master Profile ID',
        'Primary key of the golden, resolved customer record.',
        'SYSTEM',
        'cdp_master_profiles',
        'UUID',
        'all',
    ...
    (
        ...
        'tenant_id',
        'Tenant ID',
        'Workspace/tenant scope used for multi-tenant data isolation.',
        'SYSTEM',
        'cdp_master_profiles',
        'UUID',
        'all',
    ...
    (
        ...
        'domain',
        'Business Domain',
        'retail or banking; drives domain-specific UI and activation logic.',
        'SYSTEM',
        'cdp_master_profiles',
        'TEXT',
        'all',
    ...
    (
        ...
        'created_at',
        'Profile Created At',
        'Timestamp the master profile was first created.',
        'SYSTEM',
        'cdp_master_profiles',
        'TIMESTAMP',
        'all',
    ...
    (
        ...
        'updated_at',
        'Profile Updated At',
        'Timestamp of the most recent update to this profile.',
        'SYSTEM',
        'cdp_master_profiles',
        'TIMESTAMP',
        'all',
...
(
    ...
    'full_name',
    'Full Name',
    'Customer full display name; identity-resolution matching key (exact, SHA-256 hashed).',
    'IDENTITY',
    'cdp_master_profiles, cdp_raw_profiles_stage',
    'TEXT',
    'all',
    TRUE,
    'ACTIVE',
...
(
    ...
    'is_hashed',
    'PII Is Hashed',
    'True if full_name/email/phone_number/national_id are SHA-256 hashed (hashed-match ingestion). When TRUE, persona_name is required.',
    'IDENTITY',
    'cdp_master_profiles',
    'BOOLEAN',
    'all',
...
(
    ...
    'email',
    'Email Address',
    'Primary email; identity-resolution matching key (exact, SHA-256 hashed).',
    'IDENTITY',
    'cdp_master_profiles, cdp_raw_profiles_stage',
    'TEXT',
    'all',
...
(
    ...
    'phone_number',
    'Phone Number',
    'Primary phone; identity-resolution matching key (exact, SHA-256 hashed).',
    'IDENTITY',
    'cdp_master_profiles, cdp_raw_profiles_stage',
    'TEXT',
    'all',
...
(
    ...
    'secondary_emails',
    'Secondary Emails',
    'Additional emails, e.g. [{"email":"work@abc.com","label":"work"}].',
    'IDENTITY',
    'cdp_master_profiles',
    'JSONB',
    'all',
...
(
    ...
    'secondary_phones',
    'Secondary Phones',
    'Additional phone numbers, e.g. [{"phone":"+84901234567","label":"home"}].',
    'IDENTITY',
    'cdp_master_profiles',
    'JSONB',
    'all',
...
(
    ...
    'address',
    'Address',
    'Flexible address document, e.g. {"street":"123 Le Loi","city":"Ho Chi Minh","country":"VN"}.',
    'IDENTITY',
    'cdp_master_profiles',
    'JSONB',
    'all',
...
(
    ...
    'external_ids',
    'External System IDs',
    'Map of source_system to that source external customer id (deterministic matching).',
    'IDENTITY_GRAPH',
    'cdp_master_profiles',
    'JSONB',
    'all',
...
(
    ...
    'external_ids',
    'External Customer ID (raw)',
    'Per-source customer id on cdp_raw_profiles_stage (AppsFlyer customer_user_id / core banking CIF / loyalty_id); identity-resolution matching key, consolidated into external_ids.',
    'IDENTITY_GRAPH',
...
(
    ...
    'device_ids',
    'Device IDs',
    'Consolidated array of device identifiers (IDFV/Android ID/app instance id).',
    'IDENTITY_GRAPH',
    'cdp_master_profiles',
    'ARRAY',
    'all',
...
(
    ...
    'device_ids',
    'Device ID (raw)',
    'Raw per-event device id on cdp_raw_profiles_stage; identity-resolution matching key, consolidated into device_ids.',
    'IDENTITY_GRAPH',
    'cdp_raw_profiles_stage',
    'TEXT',
    'all',
...
(
    ...
    'advertising_ids',
    'Advertising IDs',
    'Consolidated array of mobile advertising identifiers (IDFA/GAID) for retargeting.',
    'IDENTITY_GRAPH',
    'cdp_master_profiles',
    'ARRAY',
    'all',
...
(
    ...
    'advertising_ids',
    'Advertising ID (raw)',
    'Raw per-event advertising id on cdp_raw_profiles_stage; identity-resolution matching key, consolidated into advertising_ids.',
    'IDENTITY_GRAPH',
    'cdp_raw_profiles_stage',
    'TEXT',
    'all',
...
(
    ...
    'cookie_ids',
    'Cookie IDs',
    'Consolidated array of anonymous browser cookies for web session stitching.',
    'IDENTITY_GRAPH',
    'cdp_master_profiles',
    'ARRAY',
    'all',
...
(
    ...
    'cookie_ids',
    'Cookie ID (raw)',
    'Raw per-event web cookie id on cdp_raw_profiles_stage; identity-resolution matching key, consolidated into cookie_ids.',
    'IDENTITY_GRAPH',
    'cdp_raw_profiles_stage',
    'TEXT',
    'all',
...
(
    ...
    'Stored push tokens, e.g. {"fcm":"token","apns":"token"}.',
    'IDENTITY_GRAPH',
    'cdp_master_profiles',
    'JSONB',
    'all',
...
(
    ...
    'loyalty_id',
    'Loyalty ID',
    'Retail loyalty program membership identifier.',
    'RETAIL',
    'cdp_master_profiles',
    'TEXT',
    'retail',
...
(
    ...
    'membership_tier',
    'Membership Tier',
    'Loyalty program tier (e.g. Silver/Gold/Platinum).',
    'RETAIL',
    'cdp_master_profiles',
    'TEXT',
    'retail',
...
(
    ...
    'preferred_store_code',
    'Preferred Store Code',
    'Physical store the customer shops at most often.',
    'RETAIL',
    'cdp_master_profiles',
    'TEXT',
    'retail',
...
(
    ...
    'national_id',
    'National ID / KYC ID',
    'CMND/CCCD/passport number; identity-resolution matching key (exact, SHA-256 hashed).',
    'BANKING',
    'cdp_master_profiles, cdp_raw_profiles_stage',
    'TEXT',
    'banking',
...
(
    'cif_number',
    'cif_number',
    'Core Banking CIF Number',
    'Customer Information File number; the golden record id in legacy core banking.',
    'BANKING',
    'cdp_master_profiles',
    'TEXT',
    'banking',
...
(
    ...
    'account_numbers',
    'Account Numbers',
    'Array of active bank account numbers associated with this CIF.',
    'BANKING',
    'cdp_master_profiles',
    'ARRAY',
    'banking',
...
(
    ...
    'risk_segment',
    'Risk Segment',
    'AML/credit risk categorization.',
    'BANKING',
    'cdp_master_profiles',
    'TEXT',
    'banking',
...
(
    ...
    'persona_name',
    'Persona Name',
    'Human-readable, non-PII label for segmentation/marketing and semantic search (e.g. "Gen Z Shopper"). Required whenever is_hashed = TRUE; auto-generated by identity-resolution-service when real PII is hashed.',
    'MARKETING',
    'cdp_master_profiles',
    'TEXT',
    'all',
...
(
    ...
    'persona_embedding',
    'Persona Embedding',
    'LLM-generated embedding used for semantic search / lookalike modeling.',
    'MARKETING',
    'cdp_master_profiles',
    'VECTOR',
    'all',
...
(
    ...
    'attributes',
    'Custom Attributes',
    'Schemaless payload of dynamically extracted traits (e.g. occupation, income_segment).',
    'MARKETING',
    'cdp_master_profiles',
    'JSONB',
    'all',
...
(
    ...
    'source_systems',
    'Source Systems',
    'All external systems that have contributed data to this profile.',
    'LINEAGE',
    'cdp_master_profiles',
    'ARRAY',
    'all',
...
(
    ...
    'last_activity_at',
    'Last Activity At',
    'Timestamp of the most recent activity across any channel; updated continuously by the streaming pipeline.',
    'LIFECYCLE',
    'cdp_master_profiles',
    'TIMESTAMP',
    'all',
...
(
    ...
    'preferred_channel',
    'Preferred Channel',
    'Channel the customer engages with most (e.g. Mobile App, Website, Internet Banking App); used for recommendation/next-best-action.',
    'LIFECYCLE',
    'cdp_master_profiles',
    'TEXT',
    'all',
...
(
    ...
    'lifecycle_stage',
    'Lifecycle Stage',
    'Current stage in the prospect-to-customer journey (prospect, lead, customer, vip, dormant, churn_risk).',
    'LIFECYCLE',
    'cdp_master_profiles',
    'TEXT',
    'all',
...
(
    ...
    'persona_summary',
    'Persona Summary',
    'Longer narrative summary of the customer''s behavior/preferences, usually generated by an LLM or the segmentation pipeline; complements persona_name.',
    'LIFECYCLE',
    'cdp_master_profiles',
    'TEXT',
    'all',
...
(
    ...
    'ML-predicted probability the profile converts or purchases a new product.',
    'LEAD_SCORING',
    'cdp_master_profiles',
    'NUMERIC',
    'all',
...
(
    ...
    'lead_grade',
    'Lead Grade',
    'Categorical grade (e.g. A/B, Hot/Cold) derived from lead_conversion_probability for quick segmentation.',
    'LEAD_SCORING',
    'cdp_master_profiles',
    'TEXT',
    'all',
...
(
    ...
    'churn_probability',
    'Churn Probability',
    'ML-predicted probability the user stops using the service/bank.',
    'CHURN_SCORING',
    'cdp_master_profiles',
    'NUMERIC',
    'all',
...
(
    ...
    'churn_risk_tier',
    'Churn Risk Tier',
    'Bucketized churn risk (low/medium/high/critical) for marketing automation.',
    'CHURN_SCORING',
    'cdp_master_profiles',
    'TEXT',
    'all',
...
(
    ...
    'clv_segment',
    'CLV Segment',
    'Combined or segmented CLV tier (e.g. high/medium/low value).',
    'CLV_SCORING',
    'cdp_master_profiles',
    'TEXT',
    'all',
...
(
    ...
    'engagement_score',
    'Engagement Score',
    'Overall interaction frequency/depth score.',
    'CX_SCORING',
    'cdp_master_profiles',
    'NUMERIC',
    'all',
...
(
    ...
    'NLP-derived sentiment from support tickets and social mentions.',
    'CX_SCORING',
    'cdp_master_profiles',
    'NUMERIC',
    'all',
...
(
    ...
    'Percentage of critical profile fields filled out.',
    'DATA_QUALITY',
    'cdp_master_profiles',
    'NUMERIC',
    'all',
...
(
    ...
    'Confidence score of the identity-stitching (CIR) algorithm.',
    'DATA_QUALITY',
    'cdp_master_profiles',
    'NUMERIC',
    'all',
    ...
    NULL,
    TRUE,
    'identity_resolution_scoring_model',
    'v1',
    'probability',
    0,
    1,
...
(
    ...
    'model_versions',
    'Model Versions',
    'Tracks which ML model versions generated the current scores, e.g. {"churn_model":"v2.1","clv_model":"v1.4"}.',
    'DATA_QUALITY',
    'cdp_master_profiles',
    'JSONB',
    'all',
...
(
    ...
    'scores_updated_at',
    'Scores Updated At',
    'Last time the batch or streaming pipelines updated the scoring fields.',
    'DATA_QUALITY',
    'cdp_master_profiles',
    'TIMESTAMP',
    'all',
    ...
    NULL,
    540
) ON CONFLICT (attribute_internal_code) DO
UPDATE
SET
...
-- identity-resolution-service (CIR) intentionally processes many tenants per
