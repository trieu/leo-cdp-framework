...
| 2 | G2-local — authenticated UI walkthrough + k6 A/B + soak | ⬜ pending | — | Needs admin creds (+captcha) and k6; load test required before claiming direct-buffer paths safe |
