...
public class LogUtil {
	...
	public static void loadLoggerConfigs() {
		LogUtil.reloadConfig(CommonUtil.getBaseDir() + "/configs/log4j.xml");
	...
	/**
	 * Change root log level at runtime using string input: DEBUG, INFO, WARN,
	 * ERROR, FATAL
	 */
	...
	private static final ThreadLocal<DateFormat> FORMATTER = ThreadLocal
