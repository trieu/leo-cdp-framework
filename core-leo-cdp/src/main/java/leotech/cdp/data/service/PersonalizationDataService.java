 ...
 *
 */
public class PersonalizationDataService extends DataServiceJob {

	
	public PersonalizationDataService() {
		super();
	}
	...
	protected String processProfileData(Profile profile) {
		...
		System.out.println(" PersonalizationDataService.processProfileData id: " + profile.getId() + " FullName " + profile.getFullName());
		// TODO 
