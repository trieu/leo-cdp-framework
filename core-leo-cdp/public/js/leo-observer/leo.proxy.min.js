...
'use strict';(function(){var n=window.leoObserverId||"";"number"!==typeof window.leoObserverBatchSize&&(window.leoObserverBatchSize=10);if("undefined"===typeof window.LeoObserverProxy&&"string"===typeof n){var t=location.protocol+"//"+location.hostname,m="https://"+window.leoObserverLogDomain,u="https://"+window.leoObserverLogDomain+"/public/html/leo-event-proxy.html#",c={synchLeoVisitorCallback:!1};window.LeoObserverProxy=c;window.LeoIframeProxy=!1;setTimeout(function(){if(null==document.getElementById("leotech_event_proxy")){var a=
